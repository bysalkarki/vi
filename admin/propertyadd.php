...
if (isset($_POST['add'])) {
    ...
    if ($result) {
        ...
        $error = "<p class='alert alert-warning'></p>";
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>BCA HOMES | Property</title>
                    ...
                    <form method="post" enctype="multipart/form-data">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="number" class="form-control" name="kitc" required
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="number" class="form-control" name="balc" required
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="number" class="form-control" name="asize" required
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <p class="alert alert-danger">* Important Please Do Not Remove Below Content Only
                                        Change <b>Yes</b> Or <b>No</b> or Details and Do Not Add More Details</p>
